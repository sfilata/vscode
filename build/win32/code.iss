...
WizardImageFile="{#RepoDir}\resources\win32\icon.bmp,{#RepoDir}\resources\win32\icon.bmp,{#RepoDir}\resources\win32\icon.bmp,{#RepoDir}\resources\win32\icon.bmp,{#RepoDir}\resources\win32\icon.bmp,{#RepoDir}\resources\win32\icon.bmp,{#RepoDir}\resources\win32\icon.bmp"
WizardSmallImageFile="{#RepoDir}\resources\win32\icon.bmp,{#RepoDir}\resources\win32\icon.bmp,{#RepoDir}\resources\win32\icon.bmp,{#RepoDir}\resources\win32\icon.bmp,{#RepoDir}\resources\win32\icon.bmp,{#RepoDir}\resources\win32\icon.bmp,{#RepoDir}\resources\win32\icon.bmp"
