!(function (e, t) {
  'object' === typeof exports && 'object' === typeof module
    ? (module.exports = t(require('vscode-debugadapter')))
    : 'function' === typeof define && define.amd
    ? define('platformio-vscode-debug', ['vscode-debugadapter'], t)
    : 'object' === typeof exports
    ? (exports['platformio-vscode-debug'] = t(require('vscode-debugadapter')))
    : (e['platformio-vscode-debug'] = t(e['vscode-debugadapter']));
})(global, function (e) {
  return (() => {
    'use strict';
    var t = {
        28: (e, t, s) => {
          Object.defineProperty(t, '__esModule', { value: !0 }), (t.MIError = t.VariableObject = void 0);
          const r = s(398);
          (t.VariableObject = class {
            constructor(e) {
              (this.name = r.MINode.valueOf(e, 'name')),
                (this.exp = r.MINode.valueOf(e, 'exp')),
                (this.numchild = parseInt(r.MINode.valueOf(e, 'numchild'))),
                (this.type = r.MINode.valueOf(e, 'type')),
                (this.value = r.MINode.valueOf(e, 'value')),
                (this.threadId = r.MINode.valueOf(e, 'thread-id')),
                (this.frozen = !!r.MINode.valueOf(e, 'frozen')),
                (this.dynamic = !!r.MINode.valueOf(e, 'dynamic')),
                (this.displayhint = r.MINode.valueOf(e, 'displayhint')),
                (this.hasMore = !!r.MINode.valueOf(e, 'has_more'));
            }
            applyChanges(e) {
              (this.value = r.MINode.valueOf(e, 'value')),
                r.MINode.valueOf(e, 'type_changed') && (this.type = r.MINode.valueOf(e, 'new_type')),
                (this.dynamic = !!r.MINode.valueOf(e, 'dynamic')),
                (this.displayhint = r.MINode.valueOf(e, 'displayhint')),
                (this.hasMore = !!r.MINode.valueOf(e, 'has_more'));
            }
            isCompound() {
              return (
                this.numchild > 0 ||
                '{...}' === this.value ||
                (this.dynamic && ('array' === this.displayhint || 'map' === this.displayhint))
              );
            }
            toProtocolVariable() {
              return {
            ...
            (t.MIError = class {
              constructor(e, t) {
                Object.defineProperty(this, 'name', {
                  ...
                  Object.defineProperty(this, 'message', { get: () => e }),
                  Object.defineProperty(this, 'source', { get: () => t }),
            ...
            Object.setPrototypeOf(t.MIError, Object.create(Error.prototype)),
            (t.MIError.prototype.constructor = t.MIError);
        },
        656: (e, t, s) => {
          Object.defineProperty(t, '__esModule', { value: !0 }), (t.expandValue = t.isExpandable = void 0);
          const r = s(398),
          ...
          (t.isExpandable = function (e) {
            return 0 === (e = e.trim()).length
              ...
              : '{' === e[0]
              ? 1
              : e.startsWith('true') || e.startsWith('false') || l.exec(e) || a.exec(e)
              ? 0
              : d.exec(e)
              ? 2
              : (u.exec(e) || h.exec(e) || n.exec(e) || o.exec(e), 0);
          }),
            (t.expandValue = function (e, t, s = '', c) {
              ...
              return (
                    ...
                    : (() => {
                        ...
                        return (
                          0 === (t = t.trim()).length
                            ? (e = void 0)
                            : t.startsWith('true')
                            ? ((e = 'true'), (t = t.substr(4).trim()))
                            : t.startsWith('false')
                            ? ((e = 'false'), (t = t.substr(5).trim()))
                            : (s = l.exec(t))
                            ? ((e = '<nullptr>'), (t = t.substr(s[0].length).trim()))
                            : (s = a.exec(t))
                            ? ((t = t.substr(s[1].length).trim()), (e = p()))
                            : (s = d.exec(t))
                            ? ((e = '*' + s[0]), (t = t.substr(s[0].length).trim()))
                            : (s = u.exec(t))
                            ? ((e = s[1]), (t = t.substr(s[0].length - 1)), (e += ' ' + p()))
                            : (s = h.exec(t)) || (s = n.exec(t)) || (s = o.exec(t))
                            ? ((e = s[0]), (t = t.substr(s[0].length).trim()))
                            : (e = t),
                          e
                        );
                ...
                (y = (t, s) => {
                  let i = 0;
                  return (
                    'object' === typeof s && ((i = e(s)), (s = 'Object')),
                    'string' === typeof s &&
                      s.startsWith('*0x') &&
                      (c && '1' === r.MINode.valueOf(c, 'arg')
                        ? ((i = e(x('*(' + t), { arg: !0 })), (s = '<args>'))
                        : ((i = e(x('*' + t))), (s = 'Object@' + s))),
                    'string' === typeof s && s.startsWith('<...>') && ((i = e(x(t))), (s = '...')),
                    { name: t, value: s, variablesReference: i }
                  );
                }),
                (g = () => {
                  if (',' === (t = t.trim())[0]) {
        ...
        789: function (e, t, s) {
          ...
          Object.defineProperty(t, '__esModule', { value: !0 }), (t.GDBDebugSession = void 0);
          const i = s(113),
            n = s(147),
            o = s(512),
            a = s(797),
          ...
          class v extends a.Event {
            constructor(e, t) {
              super('custom-stop', { reason: e, threadID: t });
            }
          }
          class y extends a.Event {
            constructor(e, t = !0) {
              super('custom-continued', { threadID: e, allThreads: t });
            }
          }
          class R extends a.DebugSession {
            constructor(e, t = !1, s = 1) {
              super(e, t),
                (this.variableHandles = new a.Handles(131072)),
                (this.variableHandlesReverse = {}),
                (this.forceDisassembly = !1),
            ...
            initDebugger() {
              this.miDebugger.on('launcherror', this.launchError.bind(this)),
                ...
                this.sendEvent(new a.InitializedEvent());
            }
            initializeRequest(e, t) {
              (e.body.supportsConditionalBreakpoints = !0),
                (e.body.supportsConfigurationDoneRequest = !0),
                (e.body.supportsEvaluateForHovers = !0),
                (e.body.supportsFunctionBreakpoints = !0),
                (e.body.supportsHitConditionalBreakpoints = !0),
                (e.body.supportsRestartRequest = !0),
                (e.body.supportsSetVariable = !0),
                (e.body.supportsTerminateRequest = !0),
                (e.body.supportsValueFormattingOptions = !0),
                this.sendResponse(e);
            }
            launchRequest(e, t) {
              ...
              this.args.projectEnvName && s.push('-e', this.args.projectEnvName),
                ...
                this.miDebugger.once('debug-ready', () => {
                  (this.debugReady = !0),
                    ...
                    this.sendEvent(new d.StoppedEvent('start', this.currentThreadId, !0)),
                    this.sendEvent(new v('start', this.currentThreadId));
                }),
                this.miDebugger
                  .connect(this.args.cwd, ['interpreter-exec console "source .pioinit"', 'enable-pretty-printing'])
                  .then(
                    () => {
                      ...
                      try {
                        ...
                        this.args.toolchainBinDir &&
                          this.sendErrorResponse(
                            e,
                            102,
                            `Failed to load symbols from executable file: ${t.toString()}`
                          );
                      }
                    },
                    (t) => {
            ...
            customRequest(e, t, s) {
              switch (e) {
                case 'set-force-disassembly':
                  (t.body = { success: !0 }),
                    (this.forceDisassembly = s.force),
                    this.stopped &&
                      ((this.activeEditorPath = null),
                      this.sendEvent(new a.ContinuedEvent(this.currentThreadId, !0)),
                      this.sendEvent(new d.StoppedEvent(this.stoppedReason, this.currentThreadId, !0))),
                    this.sendResponse(t);
                  break;
                ...
                case 'execute-command':
                  ...
                  (e = e.startsWith('-') ? e.substring(1) : `interpreter-exec console "${e}"`),
                    this.miDebugger.sendCommand(e).then(
                      (e) => {
                  ...
                  break;
                default:
                  (t.body = { error: 'Invalid command.' }), this.sendResponse(t);
              }
            }
              ...
              return r(this, void 0, void 0, function* () {
                ...
                const r = s.address,
                  ...
                  n = (yield this.miDebugger.sendCommand(
                    `data-disassemble -s ${(0, l.hexFormat)(r, 8)} -e ${(0, l.hexFormat)(i, 8)} -- 2`
                  ))
                    .result('asm_insns')
                    .map((e) => ({
            ...
            getDisassemblyForAddresses(e, t) {
              return r(this, void 0, void 0, function* () {
                const s = e + t;
                return (yield this.miDebugger.sendCommand(
                  `data-disassemble -s ${(0, l.hexFormat)(e, 8)} -e ${(0, l.hexFormat)(s, 8)} -- 2`
                ))
                  .result('asm_insns')
                  .map((e) => ({
                    address: p.MINode.valueOf(e, 'address'),
            ...
            customReadMemoryRequest(e, t, s) {
              this.miDebugger.examineMemory(t, s).then(
                (s) => {
                ...
                (t) => {
                  (e.body = { error: t }), this.sendErrorResponse(e, 114, `Unable to read memory: ${t.toString()}`);
                }
              );
            }
            customWriteMemoryRequest(e, t, s) {
              const r = (0, l.hexFormat)(t, 8);
              this.miDebugger.sendCommand(`data-write-memory-bytes ${r} ${s}`).then(
                (t) => {
                  this.sendResponse(e);
                },
                (t) => {
                  (e.body = { error: t }), this.sendErrorResponse(e, 114, `Unable to write memory: ${t.toString()}`);
                }
              );
            }
            customReadRegistersRequest(e) {
              this.miDebugger.sendCommand('data-list-register-values x').then(
                ...
                (t) => {
                  (e.body = { error: t }), this.sendErrorResponse(e, 115, `Unable to read registers: ${t.toString()}`);
                }
              );
            }
            ...
            disconnectRequest(e, t) {
              this.miDebugger && (this.attached ? this.miDebugger.detach() : this.miDebugger.stop(!0)),
                this.sendResponse(e);
            }
            ...
            restartRequest(e, t) {
              const s = () => {
                this.miDebugger.restart(['interpreter-exec console "pio_restart_target"']).then(
                  (t) => {
                    this.sendResponse(e),
                      (0, o.setTimeout)(() => {
                        (this.stopped = !0),
                          ...
                          this.sendEvent(new a.ContinuedEvent(this.currentThreadId, !0)),
                          this.sendEvent(new d.StoppedEvent('restart', this.currentThreadId, !0));
                      }, 50);
                  },
                  (t) => {
              ...
              this.stopped
                ? s()
                : (this.miDebugger.once('generic-stopped', s), this.miDebugger.sendCommand('exec-interrupt'));
            }
            ...
            handleRunning(e) {
              (this.stopped = !1),
                this.sendEvent(new a.ContinuedEvent(this.currentThreadId, !0)),
                this.sendEvent(new y(this.currentThreadId, !0));
            }
            handleBreakpoint(e) {
              const t = parseInt(e.record('thread-id') || this.currentThreadId);
              (this.stopped = !0),
                (this.stoppedReason = 'breakpoint'),
                this.sendEvent(new d.StoppedEvent('breakpoint', t, !0)),
                this.sendEvent(new v('breakpoint', t));
            }
            handleBreak(e) {
              (this.stopped = !0),
                (this.stoppedReason = 'step'),
                this.sendEvent(new d.StoppedEvent('step', this.currentThreadId, !0)),
                this.sendEvent(new v('step', this.currentThreadId));
            }
            handlePause(e) {
              (this.stopped = !0),
                (this.stoppedReason = 'user request'),
                this.sendEvent(new d.StoppedEvent('user request', this.currentThreadId, !0)),
                this.sendEvent(new v('user request', this.currentThreadId));
            }
            ...
            stopEvent(e) {
              this.started || (this.crashed = !0),
                this.quit ||
                  ((this.stopped = !0),
                  (this.stoppedReason = 'exception'),
                  this.sendEvent(new d.StoppedEvent('exception', this.currentThreadId, !0)),
                  this.sendEvent(new v('exception', this.currentThreadId)));
            }
            quitEvent() {
            ...
            setFunctionBreakPointsRequest(e, t) {
              ...
              const s = (s) =>
                  r(this, void 0, void 0, function* () {
                    ...
                    try {
                      const t = yield Promise.all(r),
                        s = [];
                      t.forEach((e) => {
                        e[0] && s.push({ line: e[1].line });
                      }),
                        (e.body = { breakpoints: s }),
                        this.sendResponse(e);
                    } catch (t) {
                  ...
                  r(this, void 0, void 0, function* () {
                    ...
                    try {
                      ...
                      (e.body = {
                        ...
                        this.breakpointMap.set(t.source.path, n),
                        this.sendResponse(e);
                    } catch (t) {
              ...
              return r(this, void 0, void 0, function* () {
                ...
                try {
                  const t = yield this.miDebugger.sendCommand('thread-list-ids'),
                    ...
                    r = t.result('current-thread-id');
                  r
                    ? (this.currentThreadId = parseInt(r))
                    : (yield this.miDebugger.sendCommand(`thread-select ${s[0]}`), (this.currentThreadId = s[0]));
                  const i = (yield Promise.all(s.map((e) => this.miDebugger.sendCommand(`thread-info ${e}`))))
                    .map((e) => {
                    ...
                    .filter((e) => null !== e);
                  (e.body = { threads: i }), this.sendResponse(e);
                } catch (t) {
            ...
            stackTraceRequest(e, t) {
              return r(this, void 0, void 0, function* () {
                try {
                  const s = yield this.miDebugger.getStack(t.threadId, t.startFrame, t.levels),
                    r = [];
                  for (const e of s) {
                    ...
                    if (
                      (n || (n = !(yield this.checkFileExists(i))),
                      !n && this.activeEditorPath && this.activeEditorPath.startsWith('disassembly://'))
                    ) {
                  ...
                  (e.body = { stackFrames: r }), this.sendResponse(e);
                } catch (t) {
            ...
            scopesRequest(e, t) {
              const s = new Array();
              s.push(new a.Scope('Local', parseInt(t.frameId), !1)),
                s.push(new a.Scope('Global', 254, !1)),
                s.push(new a.Scope('Static', f + parseInt(t.frameId), !1)),
                (e.body = { scopes: s }),
                this.sendResponse(e);
            }
            createVariable(e, t) {
            ...
            findOrCreateVariable(e) {
              let t;
              return (
                this.variableHandlesReverse.hasOwnProperty(e.name)
                  ? (t = this.variableHandlesReverse[e.name])
                  : ((t = this.createVariable(e)), (this.variableHandlesReverse[e.name] = t)),
                e.isCompound() ? t : 0
              );
            }
            getVarObjByName(e, t) {
                          ...
                          (i = [
                            {
                              ...
                              value:
                                ((r = i),
                                'object' === typeof r ? (void 0 !== r.length ? r.join(', ') : JSON.stringify(r)) : r),
                              variablesReference: 0
                            }
                          ]),
                        (t.body = { variables: i }),
                        this.sendResponse(t))
                      : this.sendErrorResponse(t, 2, 'Could not expand variable');
                  } catch (e) {
                    ...
                    try {
                      ...
                      const i = r.map((e) => {
                        ...
                        return (
                          (e.id = s),
                          /^\d+$/.test(e.exp)
                            ? (e.fullExp = `${t.fullExp || t.exp}[${e.exp}]`)
                            : (e.fullExp = `${t.fullExp || t.exp}.${e.exp}`),
                          e.toProtocolVariable()
                        );
                      });
                      (e.body = { variables: i }), this.sendResponse(e);
                    } catch (t) {
            ...
            setVariableRequest(e, t) {
              return r(this, void 0, void 0, function* () {
                try {
                  ...
                  r
                    ? (s = `${r.name}.${t.name}`)
                    : 254 === t.variablesReference
                    ? (s = `var_global_${t.name}`)
                    : t.variablesReference >= 256 && t.variablesReference < f
                    ? (s = `var_local_${t.name}`)
                    : t.variablesReference >= f && t.variablesReference <= g && (s = `var_static_${t.name}`);
                  const i = yield this.miDebugger.varAssign(s, t.value);
                  (e.body = { value: i.result('value') }), this.sendResponse(e);
                } catch (t) {
            ...
            pauseRequest(e, t) {
              this.miDebugger.interrupt(t.threadId).then(
                (t) => {
                  this.sendResponse(e);
                },
                (t) => {
            ...
            continueRequest(e, t) {
              this.miDebugger.continue(t.threadId).then(
                (t) => {
                  (e.body = { allThreadsContinued: !0 }), this.sendResponse(e);
                },
                (t) => {
              ...
              return r(this, void 0, void 0, function* () {
                try {
                  ...
                  if (!s) {
                    ...
                    if (
                      ((s = !(yield this.checkFileExists(e.file))),
                      this.activeEditorPath && this.activeEditorPath.startsWith('disassembly://'))
                    ) {
                      const t = this.symbolTable.getFunctionByName(e.function, e.fileName);
            ...
            stepOutRequest(e, t) {
              this.miDebugger.stepOut(t.threadId).then(
                (t) => {
                  this.sendResponse(e);
                },
                (t) => {
            ...
            checkFileExists(e) {
              return e
                ? this.fileExistsCache.has(e)
                  ? Promise.resolve(this.fileExistsCache.get(e))
                  : new Promise((t, s) => {
                      n.exists(e, (s) => {
        ...
        504: function (e, t, s) {
          ...
          Object.defineProperty(t, '__esModule', { value: !0 }), (t.MI2 = t.escape = void 0);
          const i = s(81),
            n = s(361),
            o = s(28),
            a = s(398);
          ...
          class p extends n.EventEmitter {
            ...
            connect(e, t) {
              return new Promise((s, r) => {
                ...
                process.env.PLATFORMIO_PATH &&
                  ((o.PATH = process.env.PLATFORMIO_PATH), (o.Path = process.env.PLATFORMIO_PATH)),
                  (this.process = i.spawn(this.application, n, {
                    cwd: e,
                    env: o,
            ...
            stdout(e) {
              ...
              -1 !== t && (this.onOutput(this.buffer.substr(0, t)), (this.buffer = this.buffer.substr(t + 1))),
                this.buffer.length && this.onOutputPartial(this.buffer) && (this.buffer = '');
            }
            stderr(e) {
              this.errbuf += 'string' === typeof e ? e : e.toString('utf8');
              const t = this.errbuf.lastIndexOf('\n');
              -1 !== t && (this.onOutputStderr(this.errbuf.substr(0, t)), (this.errbuf = this.errbuf.substr(t + 1))),
                this.errbuf.length && (this.logNoNewLine('stderr', this.errbuf), (this.errbuf = ''));
            }
            onOutputStderr(e) {
              (e = e.split('\n')).forEach((e) => {
                this.log('stderr', e);
              ...
              (e = e.split('\n')).forEach((e) => {
                if (c(e)) {
                  ...
                  void 0 !== t.token &&
                    ...
                    (this.handlers[t.token](t), delete this.handlers[t.token], (s = !0)),
                    !s &&
                      t.resultRecords &&
                      'error' === t.resultRecords.resultClass &&
                        ...
                        if (e.isStream) {
                          ...
                          if ((this.emit('exec-async-output', t), 'running' === e.asyncClass)) {
                            ...
                            'breakpoint-hit' === e
                              ...
                              : 'end-stepping-range' === e
                              ? this.emit('step-end', t)
                              : 'function-finished' === e
                              ? this.emit('step-out-end', t)
                              : 'signal-received' === e
                              ? this.emit('signal-stop', t)
                              : 'exited-normally' === e
                              ? this.emit('exited-normally', t)
                              : 'exited' === e
                              ? (this.log('stderr', 'Program exited with code ' + t.record('exit-code')),
                                this.emit('exited-normally', t))
                              : (this.debugReadyFired &&
                    ...
                    s || this.log('log', 'Unhandled: ' + JSON.stringify(t));
                }
              });
            }
            stop(e = !1) {
                ...
                e.raw ? (r += '*' + d(e.raw)) : (r += '"' + d(e.file) + ':' + e.line + '"'),
                  this.sendCommand(`break-insert ${r}`).then((r) => {
                    if ('done' === r.resultRecords.resultClass) {
                      ...
                      (e.number = i),
                        e.condition
                          ? this.setBreakPointCondition(i, e.condition).then((s) => {
            ...
            getStackVariables(e, t) {
              return r(this, void 0, void 0, function* () {
                const s = (yield this.sendCommand(
                    `stack-list-variables --thread ${e} --frame ${t} --simple-values`
                  )).result('variables'),
                  r = [];
                for (const e of s) {
                  ...
                  r.push({ name: t, valueStr: s, type: i, raw: e });
                }
                return r;
              });
            }
            examineMemory(e, t) {
              return r(this, void 0, void 0, function* () {
                ...
                for (; t > 0; ) {
                  ...
                  (s += (yield this.sendCommand(`data-read-memory-bytes 0x${r.toString(16)} ${e}`)).result(
                    'memory[0].contents'
                  )),
                    (t -= e),
                    (r += e);
            ...
            varListChildren(e) {
              return r(this, void 0, void 0, function* () {
                return ((yield this.sendCommand(`var-list-children --all-values ${e}`)).result('children') || []).map(
                  (e) => new o.VariableObject(e[1])
                );
              });
            }
            varUpdate(e = '*') {
            ...
            sendUserInput(e) {
              return e.startsWith('-')
                ? this.sendCommand(e.substr(1))
                : this.sendCommand(`interpreter-exec console "${e}"`);
            }
            sendRaw(e) {
            ...
            sendCommand(e, t = !1) {
              ...
              return new Promise((r, i) => {
                (this.handlers[s] = (s) => {
                  s && s.resultRecords && 'error' === s.resultRecords.resultClass
                    ? t
                      ? (this.log('stderr', `WARNING: Error executing command '${e}'`), r(s))
                      : i(new o.MIError(s.result('msg') || 'Internal error', e))
                    : r(s);
                }),
                  this.sendRaw(s + '-' + e);
              });
        ...
        398: (e, t) => {
          Object.defineProperty(t, '__esModule', { value: !0 }), (t.parseMI = t.MINode = void 0);
          const s = /^[0-7]{3}/;
          class r {
            constructor(e, t, s) {
          ...
          t.parseMI = function (e) {
            ...
            for (
              ...
              if (
                ((e = e.substr(v[0].length)),
                v[1] && void 0 === t && 'undefined' !== v[1] && (t = parseInt(v[1])),
                v[2])
              ) {
                const t = d.exec(e);
        ...
        527: (e, t, s) => {
          Object.defineProperty(t, '__esModule', { value: !0 }), (t.SymbolTable = void 0);
          const r = s(81),
            i = s(147),
            n = s(17),
            o = s(200),
            a =
              /^([0-9a-f]{8})\s([lg\ !])([w\ ])([C\ ])([W\ ])([I\ ])([dD\ ])([FfO\ ])\s([^\s]+)\s([0-9a-f]+)\s(.*)\r?$/,
            d = /^_Z[^\d]*(\d+)(.+)$/,
            l = {
          ...
          t.SymbolTable = class {
            ...
            loadSymbols() {
              let e = '';
              if (
                (i.readdirSync(this.toolchainBinDir).forEach((t) => {
                  t.includes('objdump') &&
                    i.existsSync(n.join(this.toolchainBinDir, t)) &&
            ...
            getStaticVariables(e) {
              return this.symbols.filter(
                (t) => t.type === o.SymbolType.Object && t.scope === o.SymbolScope.Local && t.file === e
              );
            }
            getFunctionByName(e, t) {
              let s = this.symbols.filter(
                (s) =>
                  s.type === o.SymbolType.Function && s.scope === o.SymbolScope.Local && s.name === e && s.file === t
              );
              return 0 !== s.length
                ? s[0]
                : ((s = this.symbols.filter(
                    (t) => t.type === o.SymbolType.Function && t.scope !== o.SymbolScope.Local && t.name === e
                  )),
                  0 !== s.length ? s[0] : null);
            }
          };
        ...
        200: (e, t, s) => {
          ...
          const r = s(797);
          var i, n, o;
          ((i = t.NumberFormat || (t.NumberFormat = {}))[(i.Auto = 0)] = 'Auto'),
          ...
          (t.TelemetryEvent = l),
            ((o = t.SymbolType || (t.SymbolType = {}))[(o.Function = 0)] = 'Function'),
            (o[(o.File = 1)] = 'File'),
            (o[(o.Object = 2)] = 'Object'),
            (o[(o.Normal = 3)] = 'Normal'),
            ((n = t.SymbolScope || (t.SymbolScope = {}))[(n.Local = 0)] = 'Local'),
            (n[(n.Global = 1)] = 'Global'),
