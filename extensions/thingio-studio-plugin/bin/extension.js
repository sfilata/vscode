!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? define(
        ...
        ["@nkzq/copy-paste", "vscode", "vscode-debugadapter", "xml2js"],
        t
      )
    : "object" == typeof exports
    ? (exports["platformio-vscode-debug"] = t(
        require("@nkzq/copy-paste"),
        require("vscode"),
        require("vscode-debugadapter"),
        require("xml2js")
      ))
    : (e["platformio-vscode-debug"] = t(
        e["@nkzq/copy-paste"],
        e.vscode,
        e["vscode-debugadapter"],
        e.xml2js
      ));
    ...
    var i = {
        200: (e, t, s) => {
          Object.defineProperty(t, "__esModule", { value: !0 }),
            (t.SymbolScope =
              ...
              t.TelemetryEvent =
              t.StoppedEvent =
              t.AdapterOutputEvent =
              t.NumberFormat =
                void 0);
          const r = s(797);
          var i, n, o;
          ((i = t.NumberFormat || (t.NumberFormat = {}))[(i.Auto = 0)] =
            "Auto"),
            (i[(i.Hexidecimal = 1)] = "Hexidecimal"),
            (i[(i.Decimal = 2)] = "Decimal"),
            (i[(i.Binary = 3)] = "Binary");
          class a extends r.Event {
            constructor(e, t) {
              super("adapter-output", { content: e, type: t });
            }
          }
          ...
          (t.TelemetryEvent = h),
            ((o = t.SymbolType || (t.SymbolType = {}))[(o.Function = 0)] =
              "Function"),
            (o[(o.File = 1)] = "File"),
            (o[(o.Object = 2)] = "Object"),
            (o[(o.Normal = 3)] = "Normal"),
            ((n = t.SymbolScope || (t.SymbolScope = {}))[(n.Local = 0)] =
              "Local"),
            (n[(n.Global = 1)] = "Global"),
            (n[(n.Neither = 2)] = "Neither"),
            (n[(n.Both = 3)] = "Both");
        },
        719: function (e, t, s) {
          var r =
          ...
          t.DisassemblyContentProvider = class {
            provideTextDocumentContent(e, t) {
              return new Promise((t, s) => {
                ...
                r.debug.activeDebugSession
                  .customRequest("disassemble", {
                    function: n.func,
                    file: n.file
                  })
                  .then(
                    (e) => {
                      ...
                      let r = "";
                      s.forEach((e) => {
                        r += `${e.address}: ${this.padEnd(15, e.opcodes)} \t${
                          e.instruction
                        }\n`;
                      }),
                        t(r);
        ...
        842: (e, t, s) => {
          ...
          t.DisassemblyTreeProvider = class {
            constructor() {
              (this._onDidChangeTreeData = new r.EventEmitter()),
          ...
          class f {
            constructor(e) {
              (this.adapterOutputChannel = null),
                ...
                (this.context = e),
                (this.registerProvider = new p.RegisterTreeProvider()),
                (this.peripheralProvider = new m.PeripheralTreeProvider()),
                (this.memoryTreeProvider = new c.MemoryTreeProvider()),
                (this.disassemblyTreeProvider =
                  new l.DisassemblyTreeProvider()),
                (this.memoryContentProvider = new u.MemoryContentProvider());
              const t = n.window.createTreeView(
                "thingio-debug.peripherals",
                { treeDataProvider: this.peripheralProvider }
              );
              e.subscriptions.push(
                n.debug.registerDebugConfigurationProvider(
                  "thingio-debug",
                  new d.PlatformIODebugConfigurationProvider()
                ),
                t,
                t.onDidExpandElement(
                  this.peripheralProvider.onDidExpandElement.bind(
                    this.peripheralProvider
                  )
                ),
                t.onDidCollapseElement(
                  this.peripheralProvider.onDidCollapseElement.bind(
                    this.peripheralProvider
                  )
                ),
                n.window.registerTreeDataProvider(
                  "thingio-debug.registers",
                  this.registerProvider
                ),
                n.window.registerTreeDataProvider(
                  "thingio-debug.memory",
                  this.memoryTreeProvider
                ),
                n.window.registerTreeDataProvider(
                  "thingio-debug.disassembly",
                  this.disassemblyTreeProvider
                ),
                ...
                n.workspace.registerTextDocumentContentProvider(
                  "disassembly",
                  new h.DisassemblyContentProvider()
                ),
                n.commands.registerCommand(
                  "thingio-debug.peripherals.updateNode",
                  this.peripheralsUpdateNode.bind(this)
                ),
                n.commands.registerCommand(
                  "thingio-debug.peripherals.selectedNode",
                  this.peripheralsSelectedNode.bind(this)
                ),
                n.commands.registerCommand(
                  "thingio-debug.peripherals.copyValue",
                  this.peripheralsCopyValue.bind(this)
                ),
                n.commands.registerCommand(
                  "thingio-debug.peripherals.setFormat",
                  this.peripheralsSetFormat.bind(this)
                ),
                n.commands.registerCommand(
                  "thingio-debug.registers.selectedNode",
                  this.registersSelectedNode.bind(this)
                ),
                n.commands.registerCommand(
                  "thingio-debug.registers.copyValue",
                  this.registersCopyValue.bind(this)
                ),
                n.commands.registerCommand(
                  "thingio-debug.registers.setFormat",
                  this.registersSetFormat.bind(this)
                ),
                n.commands.registerCommand(
                  "thingio-debug.memory.deleteHistoryItem",
                  this.memoryDeleteHistoryItem.bind(this)
                ),
                n.commands.registerCommand(
                  "thingio-debug.memory.clearHistory",
                  this.memoryClearHistory.bind(this)
                ),
                n.commands.registerCommand(
                  "thingio-debug.examineMemory",
                  this.examineMemory.bind(this)
                ),
                n.commands.registerCommand(
                  "thingio-debug.viewDisassembly",
                  this.showDisassembly.bind(this)
                ),
                n.commands.registerCommand(
                  "thingio-debug.setForceDisassembly",
                  this.setForceDisassembly.bind(this)
                ),
                n.debug.onDidReceiveDebugSessionCustomEvent(
                  this.receivedCustomEvent.bind(this)
                ),
                n.debug.onDidStartDebugSession(
                  this.debugSessionStarted.bind(this)
                ),
                n.debug.onDidTerminateDebugSession(
                  this.debugSessionTerminated.bind(this)
                ),
                n.window.onDidChangeActiveTextEditor(
                  this.activeEditorChanged.bind(this)
                ),
                n.window.onDidChangeTextEditorSelection((e) => {
                  e &&
                    e.textEditor.document.fileName.endsWith(".dbgmem") &&
            ...
            isPIODebugSession() {
              return (
                n.debug.activeDebugSession &&
                "thingio-debug" === n.debug.activeDebugSession.type
              );
            }
            activeEditorChanged(e) {
              ...
              "file" === t.scheme
                ? n.debug.activeDebugSession.customRequest(
                    "set-active-editor",
                    { path: t.path }
                  )
                : "disassembly" === t.scheme &&
                  n.debug.activeDebugSession.customRequest(
                    "set-active-editor",
              ...
              return r(this, void 0, void 0, function* () {
                if (this.isPIODebugSession()) {
                  if (!this.functionSymbols)
                    try {
                      const e = yield n.debug.activeDebugSession.customRequest(
                        "load-function-symbols"
                      );
                      this.functionSymbols = e.functionSymbols;
                    } catch (e) {
                      n.window.showErrorMessage(
                        "Unable to load symbol table. Disassembly view unavailable."
                      );
                    }
                  try {
                    ...
                    let s;
                    if (1 === t.length)
                      s = (0, a.encodeDisassembly)(t[0].name, t[0].file);
                    else {
                      if (!(t.length > 1))
                        return n.window.showErrorMessage(
                          `No function with name ${e} found.`
                        );
                      {
                        const e = yield n.window.showQuickPick(
                          t.map((e) => ({
                            label: e.name,
                            name: e.name,
                            file: e.file,
            ...
            setForceDisassembly(e) {
              const t = (e) => {
                const t = "Forced" === e;
                return (
                  this.disassemblyTreeProvider.updateForcedState(t),
                  n.debug.activeDebugSession.customRequest(
                    "set-force-disassembly",
                    { force: t }
                  )
                );
              };
              ...
              n.window
                .showQuickPick(
                  [
                    {
                      label: "Auto",
                      description:
                        "Show disassembly for functions when source cannot be located."
                    },
                    {
                      label: "Forced",
                  ...
                  { matchOnDescription: !0, ignoreFocusOut: !0 }
                )
                .then(
                  (e) => {
                    t(e.label);
            ...
            examineMemory(e, t) {
              function s(e) {
                return /^0x[0-9a-f]{1,8}$/i.test(e) || /^[0-9]+$/i.test(e)
                  ? e
                  : null;
              }
              if (this.isPIODebugSession())
                return e && t
                  ? this.showMemoryContent(e, t)
                  : void n.window
                      .showInputBox({
                        ...
                        (e) => {
                          s(e)
                            ? n.window
                                .showInputBox({
                                  placeHolder:
                                    "Prefix with 0x for hexidecimal format",
                                  ignoreFocusOut: !0,
                                ...
                                .then(
                                  (t) => {
                                    s(t)
                                      ? (this.memoryTreeProvider.pushHistory(
                                          e,
                                          t
                                        ),
                                        this.showMemoryContent(e, t))
                            ...
                            : n.window.showErrorMessage(
                                "Invalid memory address entered"
                              );
                        },
                        (e) => {}
                      );
            ...
            showMemoryContent(e, t) {
              n.workspace
                .openTextDocument(
                  n.Uri.parse(
                    `examinememory:///Memory%20[${e}+${t}].dbgmem?address=${e}&length=${t}&timestamp=${new Date().getTime()}`
                  )
                )
                .then(
                  (e) => {
            ...
            peripheralsUpdateNode(e) {
              e.node.performUpdate().then(
                (e) => {
                  e && this.peripheralProvider.refresh();
                },
                (e) => {
                  n.window.showErrorMessage(
                    `Unable to update value: ${e.toString()}`
                  );
                }
              );
            }
            peripheralsSelectedNode(e) {
              e.recordType !== m.RecordType.Field && (e.expanded = !e.expanded),
                e.selected().then(
                  (e) => {
                    e && this.peripheralProvider.refresh();
                  },
                ...
                const t = yield n.window.showQuickPick([
                  {
                    label: "Auto",
                    description:
                      "Automatically choose format (Inherits from parent)",
            ...
            debugSessionStarted(e) {
              "thingio-debug" === e.type &&
                ((this.functionSymbols = null),
                e.customRequest("get-arguments").then(
                  (e) => {
            ...
            receivedStopEvent(e) {
              this.peripheralProvider.debugStopped(),
                ...
                n.workspace.textDocuments
                  .filter((e) => e.fileName.endsWith(".dbgmem"))
                  .forEach((e) => {
            ...
            receivedAdapterOutput(e) {
              this.adapterOutputChannel ||
                (this.adapterOutputChannel =
                  n.window.createOutputChannel("Adapter Output"));
          ...
          t.MemoryContentProvider = class {
            constructor() {
              (this._onDidChange = new r.EventEmitter()),
                ...
                (this.lastBytePos = this.firstBytePos + 48 - 1),
                (this.firstAsciiPos = this.lastBytePos + 3),
                (this.lastAsciiPos = this.firstAsciiPos + 16),
                (this.smallDecorationType =
                  r.window.createTextEditorDecorationType({
                    borderWidth: "1px",
                    borderStyle: "solid",
            ...
            provideTextDocumentContent(e) {
              return new Promise((t, s) => {
                const n = (0, i.parseQuery)(e.query),
                  o = n.address.startsWith("0x")
                    ? parseInt(n.address.substring(2), 16)
                    : parseInt(n.address, 10),
                  a = n.length.startsWith("0x")
                    ? parseInt(n.length.substring(2), 16)
                    : parseInt(n.length, 10);
                r.debug.activeDebugSession
                  .customRequest("read-memory", { address: o, length: a || 32 })
                  .then(
                    (e) => {
                      const s = e.bytes;
                      let r = o - (o % 16);
                      ...
                      for (let e = 0; e < a; e++) {
                        const t = s[e];
                        (d += (0, i.hexFormat)(t, 2, !1).toUpperCase() + " "),
                          (h +=
                            t <= 32 || (t >= 127 && t <= 159)
                              ? "."
                              : String.fromCharCode(s[e])),
                          (o + e) % 16 == 15 &&
                            e < a - 1 &&
                            ((d += "  " + h),
                            (h = ""),
                    ...
                    (e) => {
                      r.window.showErrorMessage(
                        `Unable to read memory from ${(0, i.hexFormat)(
                          o,
                          8
                        )} to ${(0, i.hexFormat)(o + a, 8)}`
                      ),
                        s(e.toString());
                    }
                  );
            ...
            getOffset(e) {
              ...
              return (
                ...
                e.character <= this.lastBytePos
                  ? (t += Math.floor(s / 3))
                  : e.character >= this.firstAsciiPos &&
            ...
            getPosition(e, t = !1) {
              ...
              let i = e % 16;
              return (
                t ? (i += this.firstAsciiPos) : (i = this.firstBytePos + 3 * i),
                new r.Position(s, i)
              );
            }
            getRanges(e, t, s) {
            ...
            handleSelection(e) {
              ...
              if (
                e.selections[0].start.line + 1 === t ||
                e.selections[0].end.line + 1 === t
              )
                return void e.textEditor.setDecorations(
                  this.smallDecorationType,
                  []
                );
              ...
              (i = i.concat(this.getRanges(s, r, !0))),
                e.textEditor.setDecorations(this.smallDecorationType, i);
            }
          };
        },
        558: (e, t, s) => {
          ...
          t.MemoryTreeProvider = class {
            ...
            pushHistory(e, t) {
              const s = `${e}+${t}`;
              this.history.includes(s) ||
                (this.history.push(s), this.refresh());
            }
            deleteHistory(e, t) {
              const s = `${e}+${t}`;
              this.history.includes(s) &&
                ((this.history = this.history.filter((e) => e !== s)),
                this.refresh());
            }
            clearHistory() {
        ...
        632: function (e, t, s) {
          ...
          class m {
            constructor(e) {
              (this.recordType = e),
                (this.expanded = !1),
                (this.format = a.NumberFormat.Auto);
            }
            selected() {
          ...
          function p(e) {
            return /^0b([01]+)$/i.test(e)
              ? parseInt(e.substring(2), 2)
              : /^0x([0-9a-f]+)$/i.test(e)
              ? parseInt(e.substring(2), 16)
              : /^[0-9]+/i.test(e)
              ? parseInt(e, 10)
              : /^#[0-1]+/i.test(e)
              ? parseInt(e.substring(1), 2)
              : void 0;
          }
          function f(e, t) {
            if (-1 !== e.indexOf(",")) {
          ...
          class b extends m {
            constructor(e) {
              super(h.Peripheral),
                ...
                (this.baseAddress = e.baseAddress),
                (this.totalLength = e.totalLength),
                (this.groupName = e.groupName || ""),
                (this.resetValue = e.resetValue || 0),
                (this.size = e.size || 32),
                (this.children = []);
            }
            getTreeNode() {
              const e =
                this.name + "  [" + (0, d.hexFormat)(this.baseAddress) + "]";
              return new c(
                e,
                this.expanded
                  ? n.TreeItemCollapsibleState.Expanded
                  : n.TreeItemCollapsibleState.Collapsed,
                "peripheral",
                this
              );
            }
            ...
            setChildren(e) {
              (this.children = e),
                this.children.sort((e, t) => (e.offset > t.offset ? 1 : -1));
            }
            addChild(e) {
                ...
                this.expanded
                  ? n.debug.activeDebugSession
                      .customRequest("read-memory", {
                        ...
                        length:
                          this.totalLength > 32768 ? 32768 : this.totalLength
                      })
                      .then(
                        (t) => {
                          (this.currentValue = t.bytes),
            ...
            dumpSettings() {
              const e = [];
              return (
                (this.format !== a.NumberFormat.Auto || this.expanded) &&
                  e.push({
                    node: `${this.name}`,
          ...
          class y extends m {
            constructor(e, t) {
              super(h.Cluster),
                ...
                (this.offset = t.addressOffset),
                (this.accessType = t.accessType || l.ReadWrite),
                (this.size = t.size || e.size),
                (this.resetValue = t.resetValue || e.resetValue),
                (this.children = []),
            ...
            setChildren(e) {
              (this.children = e.slice(0, e.length)),
                this.children.sort((e, t) => (e.offset > t.offset ? 1 : -1));
            }
            addChild(e) {
              this.children.push(e),
          ...
          class v extends m {
            constructor(e, t) {
              super(h.Register),
                ...
                (this.description = t.description),
                (this.offset = t.addressOffset),
                (this.accessType = t.accessType || e.accessType),
                (this.size = t.size || e.size),
                (this.resetValue =
                  void 0 !== t.resetValue ? t.resetValue : e.resetValue),
                (this.currentValue = this.resetValue),
                (this.hexLength = Math.ceil(this.size / 4)),
                (this.maxValue = Math.pow(2, this.size)),
                (this.binaryRegex = new RegExp(
                  `^0b[01]{1,${this.size}}$`,
                  "i"
                )),
                (this.hexRegex = new RegExp(
                  `^0x[0-9a-f]{1,${this.hexLength}}$`,
                  "i"
                )),
                (this.children = []),
                this.parent,
            ...
            updateBits(e, t, s) {
              return new Promise((r, i) => {
                ...
                if (s > n)
                  return i(
                    `Value entered is invalid. Maximum value for this field is ${
                      n - 1
                    } (${(0, d.hexFormat)(n - 1, 0)})`
                  );
                {
            ...
            getTreeNode() {
              let e = "registerRW";
              this.accessType === l.ReadOnly
                ? (e = "registerRO")
                : this.accessType === l.WriteOnly && (e = "registerWO");
            ...
            performUpdate() {
              return new Promise((e, t) => {
                n.window
                  .showInputBox({
                    prompt:
                      "Enter new value: (prefix hex with 0x, binary with 0b)"
                  })
                  .then((s) => {
                    let r;
                    if (s.match(this.hexRegex)) r = parseInt(s.substr(2), 16);
                    else if (s.match(this.binaryRegex))
                      r = parseInt(s.substr(2), 2);
                    else {
                      if (!s.match(/^[0-9]+/))
                        return t("Value entered is not a valid format.");
                      if (((r = parseInt(s, 10)), r >= this.maxValue))
                        return t(
                          `Value entered (${r}) is greater than the maximum value of ${this.maxValue}`
                        );
                    }
            ...
            update() {
              ...
              return (
                this.children.forEach((e) => e.update()), Promise.resolve(!0)
              );
            }
            dumpSettings(e) {
              const t = [];
            ...
            _findByPath(e) {
              return 0 === e.length
                ? this
                : 1 === e.length
                ? this.children.find((t) => t.name === e[0])
                : null;
            }
          }
          t.RegisterNode = v;
          class w extends m {
            constructor(e, t) {
              if (
                ...
                (this.width = t.width),
                t.accessType
                  ? e.accessType === l.ReadOnly && t.accessType !== l.ReadOnly
                    ? (this.accessType = l.ReadOnly)
                    : e.accessType === l.WriteOnly &&
                      t.accessType !== l.WriteOnly
                    ? (this.accessType = l.WriteOnly)
            ...
            getTreeNode() {
              ...
              let i = "field";
              if (
                ((s += `[${this.offset + this.width - 1}:${r}]`),
                "reserved" === this.name.toLowerCase())
              )
                i = "field-res";
                ...
                switch (this.getFormat()) {
                  ...
                  default:
                    r =
                      this.width >= 4
                        ? (0, d.hexFormat)(e, Math.ceil(this.width / 4), !0)
                        : (0, d.binaryFormat)(e, this.width);
                }
                this.enumeration && this.enumeration[e]
                  ? ((t = this.enumeration[e]), (s += ` = ${t.name} (${r})`))
                  : (s += ` = ${r}`);
              }
              return (
                this.parent.accessType === l.ReadOnly && (i = "field-ro"),
                new c(s, n.TreeItemCollapsibleState.None, i, this)
              );
            }
            performUpdate() {
              return new Promise((e, t) => {
                this.enumeration
                  ? n.window.showQuickPick(this.enumerationValues).then((s) => {
                      if (void 0 === s) return t("Input not selected");
                      const r = this.enumerationMap[s];
                      this.parent
                        .updateBits(this.offset, this.width, r)
                        .then(e, t);
                    })
                  : n.window
                      .showInputBox({
                      ...
                      .then((s) => {
                        const r = p(s);
                        if (void 0 === r)
                          return t("Unable to parse input value.");
                        this.parent
                          .updateBits(this.offset, this.width, r)
                          .then(e, t);
                      });
            ...
            dumpSettings(e) {
              return this.format !== a.NumberFormat.Auto
                ? [{ node: `${e}.${this.name}`, format: this.format }]
                : [];
            }
            _findByPath(e) {
          ...
          (t.FieldNode = w),
            (t.PeripheralTreeProvider = class {
              constructor() {
              ...
              _parseFields(e, t) {
                ...
                return (
                  e.map((e) => {
                    ...
                    if (e.bitOffset && e.bitWidth)
                      (r = p(e.bitOffset[0])), (i = p(e.bitWidth[0]));
                    else if (e.bitRange) {
                      let t = e.bitRange[0];
                      ...
                      if (!e.msb || !e.lsb)
                        throw new Error(
                          `Unable to parse SVD file: field ${e.name[0]} must have either bitOffset and bitWidth elements, bitRange Element, or msb and lsb elements.`
                        );
                      {
                        const t = p(e.msb[0]),
                          s = p(e.lsb[0]);
                    ...
                    e.enumeratedValues &&
                      ((o = {}),
                      e.enumeratedValues[0].enumeratedValue.map((e) => {
                    ...
                    if (e.dim) {
                      if (!e.dimIncrement)
                        throw new Error(
                          `Unable to parse SVD file: field ${e.name[0]} has dim element, with no dimIncrement element.`
                        );
                      const i = p(e.dim[0]),
                        n = p(e.dimIncrement[0]);
                      let o = [];
                      if (e.dimIndex) o = f(e.dimIndex[0], i);
                      else for (let e = 0; e < i; e++) o.push(`${e}`);
                      const d = e.name[0],
                        h = r;
                      for (let e = 0; e < i; e++) {
              ...
              _parseRegisters(e, t) {
                ...
                return (
                  e.forEach((e) => {
                    const r = {};
                    if (
                      (e.description && (r.description = e.description[0]),
                      e.access && (r.accessType = u[e.access[0]]),
                      e.size && (r.size = p(e.size[0])),
                      e.resetValue && (r.resetValue = p(e.resetValue[0])),
                      e.dim)
                    ) {
                      if (!e.dimIncrement)
                        throw new Error(
                          `Unable to parse SVD file: register ${e.name[0]} has dim element, with no dimIncrement element.`
                        );
                      const i = p(e.dim[0]),
                        n = p(e.dimIncrement[0]);
                      let o = [];
                      ...
                      for (let h = 0; h < i; h++) {
                        ...
                        e.fields &&
                          1 === e.fields.length &&
                          this._parseFields(e.fields[0].field, l),
                          s.push(l);
                      }
                    } else {
                      const i = new v(
                      ...
                      e.fields &&
                        1 === e.fields.length &&
                        this._parseFields(e.fields[0].field, i),
                        s.push(i);
                    }
                  }),
                  s.sort((e, t) =>
                ...
                return e
                  ? (e.forEach((e) => {
                      ...
                      if (
                        ...
                        e.access && (r.accessType = u[e.access[0]]),
                        e.size && (r.size = p(e.size[0])),
                        e.resetValue && (r.resetValue = p(e.resetValue)),
                        e.dim)
                      ) {
                        if (!e.dimIncrement)
                          throw new Error(
                            `Unable to parse SVD file: cluster ${e.name[0]} has dim element, with no dimIncrement element.`
                          );
                        const i = p(e.dim[0]),
                          n = p(e.dimIncrement[0]);
                        let o = [];
                        ...
                        for (let h = 0; h < i; h++) {
                          ...
                          e.register && this._parseRegisters(e.register, l),
                            s.push(l);
                        }
                      } else {
                        const i = new y(
                        ...
                        e.register &&
                          (this._parseRegisters(e.register, i), s.push(i));
                      }
                    }),
                    s)
                  : [];
              ...
              _parsePeripheral(e, t) {
                ...
                e.access && (r.accessType = u[e.access[0]]),
                  e.size && (r.size = p(e.size[0])),
                  e.resetValue && (r.resetValue = p(e.resetValue[0])),
                  e.groupName && (r.groupName = e.groupName[0]);
                const i = new b(r);
                return (
                  e.registers[0].register &&
                    this._parseRegisters(e.registers[0].register, i),
                  e.registers[0].cluster &&
                    this._parseClusters(e.registers[0].cluster, i),
                  i
                );
              }
              _loadSVD(e) {
                  ...
                  i.readFile(e, "utf8", (e, r) => {
                    ...
                    o.parseString(r, (e, r) => {
                      ...
                      try {
                        ...
                        r.device.resetValue &&
                          (s.resetValue = p(r.device.resetValue[0])),
                          r.device.size && (s.size = p(r.device.size[0])),
                          r.device.access &&
                            (s.accessType = u[r.device.access[0]]),
                          r.device.peripherals[0].peripheral.forEach((t) => {
                            const s = t.name[0];
                            e[s] = t;
                          });
                        for (const t in e) {
                        ...
                        this.peripherials = [];
                        for (const t in e)
                          this.peripherials.push(
                            this._parsePeripheral(e[t], s)
                          );
                        return (
                          this.peripherials.sort((e, t) =>
              ...
              getChildren(e) {
                return (
                  (this.viewExpanded = !0),
                  n.debug.activeDebugSession
                    ? this.peripherials.length > 0
                      ? e
                        ? e.node.getChildren().map((e) => e.getTreeNode())
                        : this.peripherials.map((e) => e.getTreeNode())
                      : (this.loaded || this._update(),
                        [
                          new c(
                        ...
                        setTimeout(
                          () =>
                            r(this, void 0, void 0, function* () {
                              try {
                                yield this._loadSVD(this.svdPath),
                                  this.initialSettings &&
                                    this.initialSettings.forEach((e) => {
                                      const t = this._findNodeByPath(e.node);
                                      t &&
                                        ((t.expanded = e.expanded || !1),
                                        (t.format = e.format));
                                    });
                              } catch (e) {
                                (this.peripherials = []),
                                  n.window.showErrorMessage(
                                    `Unable to parse SVD file: ${e.toString()}`
                                  );
                              }
                              e(!0);
                            }),
              ...
              _update() {
                return r(this, void 0, void 0, function* () {
                  if (this.viewExpanded) {
                    ...
                    try {
                      yield Promise.all(
                        this.peripherials.map((e) => e.update())
                      );
                    } catch (e) {}
                    this.refresh();
                  }
              ...
              onDidExpandElement(e) {
                (e.element.node.expanded = !0),
                  e.element.node.update(),
                  this.refresh();
              }
        ...
        755: (e, t, s) => {
          ...
          class d {
            constructor(e) {
              (this.recordType = e),
                (this.format = i.NumberFormat.Auto),
                (this.expanded = !1);
            }
            getChildren() {
              return [];
          ...
          class h extends d {
            constructor(e, t) {
              super(o.Register),
                ...
                (this.index = t),
                (this.name = this.name),
                "XPSR" === e.toUpperCase() || "CPSR" === e.toUpperCase()
                  ? (this.fields = [
                      new l("Negative Flag (N)", 31, 1, this),
                      new l("Zero Flag (Z)", 30, 1, this),
                      new l("Carry or borrow flag (C)", 29, 1, this),
                      new l("Overflow Flag (V)", 28, 1, this),
                      new l("Saturation Flag (Q)", 27, 1, this),
                      new l("GE", 16, 4, this),
                      new l("Interrupt Number", 0, 8, this),
                      new l("ICI/IT", 25, 2, this),
                      new l("ICI/IT", 10, 6, this),
                      new l("Thumb State (T)", 24, 1, this)
                    ])
                  : "CONTROL" === e.toUpperCase() &&
                    (this.fields = [
                      new l("FPCA", 2, 1, this),
                      new l("SPSEL", 1, 1, this),
                      new l("nPRIV", 0, 1, this)
                    ]),
                (this.currentValue = 0);
            }
            extractBits(e, t) {
            ...
            getTreeNode() {
              ...
              return this.fields && this.fields.length > 0
                ? new a(
                    e,
                    this.expanded
                      ? r.TreeItemCollapsibleState.Expanded
                      : r.TreeItemCollapsibleState.Collapsed,
                    "register",
                    this
                  )
                : new a(e, r.TreeItemCollapsibleState.None, "register", this);
            }
            getChildren() {
              return this.fields;
            }
            ...
            dumpSettings() {
              const e = [];
              return (
                (this.expanded || this.format !== i.NumberFormat.Auto) &&
                  e.push({
                    node: this.name,
                    format: this.format,
                    expanded: this.expanded
            ...
            getTreeNode() {
              ...
              switch (this.getFormat()) {
                ...
                default:
                  t +=
                    this.size >= 4
                      ? (0, n.hexFormat)(e, Math.ceil(this.size / 4), !0)
                      : (0, n.binaryFormat)(e, this.size, !1, !0);
              }
              ...
              fetchRegisterList() {
                r.debug.activeDebugSession &&
                  (this.loaded
                    ...
                    : r.debug.activeDebugSession
                        .customRequest("read-register-list")
                        .then((e) => {
                          (this.loaded = !0),
                            this.createRegisters(e),
                            this._fetchRegisterValues();
                        }));
              }
              _fetchRegisterValues() {
                r.debug.activeDebugSession
                  .customRequest("read-registers")
                  .then((e) => {
                    e.forEach((e) => {
                  ...
                  this.initialSettings &&
                    this.initialSettings.forEach((e) => {
                      if (-1 === e.node.indexOf(".")) {
                        ...
                        t &&
                          (e.expanded && (t.expanded = e.expanded),
                          e.format && t.setFormat(e.format));
                      } else {
                        const [t, s] = e.node.split("."),
                          r = this.registers.find((e) => e.name === t);
                        if (r) {
                ...
                return (
                  ...
                  r.debug.activeDebugSession
                    ? this.registers.length > 0
                      ? e
                        ? e.node.getChildren().map((e) => e.getTreeNode())
                        : this.registers.map((e) => e.getTreeNode())
                      : (this.loaded ||
                          setTimeout(() => this.fetchRegisterList(), 1e3),
                        [
                          new a(
                            "Loading...",
                            r.TreeItemCollapsibleState.None,
                            "message",
                            null
                          )
                        ])
